...
public class PoplarFoliagePlacer extends FoliagePlacer {
    ...
    @Override
    protected void createFoliage(LevelSimulatedReader level, BiConsumer<BlockPos, BlockState> blockSetter, RandomSource random,
    ...
    private void placeLeavesRow(LevelSimulatedReader level, BiConsumer<BlockPos, BlockState> blockSetter, RandomSource random,
    ...
    private void replaceLeavesWithLog(LevelSimulatedReader level, BiConsumer<BlockPos, BlockState> blockSetter,
    ...
    private static void tryPlaceLog(LevelSimulatedReader level, BiConsumer<BlockPos, BlockState> blockSetter,
        ...
        if (level.isStateAtPosition(pos,
            ...
            blockSetter.accept(pos, stateModifier.apply(config.trunkProvider.getState(random, pos)));
        }
    }

    private static Function<BlockState, BlockState> getSidewaysStateModifier(Direction direction) {
        return state -> state.hasProperty(RotatedPillarBlock.AXIS)
