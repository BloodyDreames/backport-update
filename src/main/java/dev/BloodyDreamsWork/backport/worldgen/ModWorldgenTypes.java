...
public final class ModWorldgenTypes {
    public static final DeferredRegister<FoliagePlacerType<?>> FOLIAGE_PLACERS =
            DeferredRegister.create(Registry.FOLIAGE_PLACER_TYPE_REGISTRY, Backport.MODID);

    public static final DeferredRegister<TrunkPlacerType<?>> TRUNK_PLACERS =
            DeferredRegister.create(Registry.TRUNK_PLACER_TYPE_REGISTRY, Backport.MODID);
    ...
    public static final DeferredRegister<TreeDecoratorType<?>> TREE_DECORATORS =
            DeferredRegister.create(Registry.TREE_DECORATOR_TYPE_REGISTRY, Backport.MODID);

    public static final RegistryObject<TreeDecoratorType<ShelfMushroomDecorator>> SHELF_MUSHROOM_DECORATOR =
            TREE_DECORATORS.register("shelf_mushroom",
                    () -> new TreeDecoratorType<>(ShelfMushroomDecorator.CODEC.codec()));

    public static final RegistryObject<TreeDecoratorType<AttachedToLogsDecorator>> ATTACHED_TO_LOGS_DECORATOR =
            TREE_DECORATORS.register("attached_to_logs",
                    () -> new TreeDecoratorType<>(AttachedToLogsDecorator.CODEC.codec()));

    public static final DeferredRegister<Feature<?>> FEATURES =
            DeferredRegister.create(Registry.FEATURE_REGISTRY, Backport.MODID);

    public static final RegistryObject<FallenTreeFeature> FALLEN_TREE =
