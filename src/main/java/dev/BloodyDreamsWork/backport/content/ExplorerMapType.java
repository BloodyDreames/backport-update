...
public enum ExplorerMapType {
    ...
    ABANDONED_CAMPSITE("abandoned_campsite_map", "abandoned_campsite_map",
            structureTag("abandoned_camp"), ModMapDecorations.ABANDONED_CAMP::getDelegate),

    ANCIENT_CITY("ancient_city_map", "ancient_city_map",
            structureTag("on_ancient_city_maps"), ModMapDecorations.ANCIENT_CITY::getDelegate),
    MINESHAFT("mineshaft_map", "mineshaft_map",
            structureTag("on_mineshaft_maps"), ModMapDecorations.MINESHAFT::getDelegate),
    DESERT_PYRAMID("desert_pyramid_map", "desert_pyramid_map",
            structureTag("on_desert_pyramid_maps"), ModMapDecorations.DESERT_PYRAMID::getDelegate),
