...
public class CushionRenderer extends EntityRenderer<CushionEntity> {
    ...
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(
            new ResourceLocation(Backport.MODID, "cushion"), "main");
    ...
    public void render(CushionEntity entity, float entityYaw, float partialTick,
        ...
        poseStack.pushPose();
        poseStack.mulPose(Vector3f.YP.rotationDegrees(180.0F - Mth.rotLerp(partialTick, entity.yRotO, entity.getYRot())));
        poseStack.scale(-1.0F, -1.0F, 1.0F);

        VertexConsumer consumer = buffers.getBuffer(RenderType.entityCutoutNoCullZOffset(this.getTextureLocation(entity)));
    ...
    private static Map<DyeColor, ResourceLocation> textures() {
        ...
        for (DyeColor color : DyeColor.values()) {
            result.put(color, new ResourceLocation(Backport.MODID,
