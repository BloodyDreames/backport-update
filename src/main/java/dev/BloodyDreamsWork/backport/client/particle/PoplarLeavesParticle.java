...
public class PoplarLeavesParticle {
    ...
    public record Provider(SpriteSet sprites) implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
                                       ...
                                       RandomSource random) {
            return new PoplarFallingLeavesParticle(level, x, y, z, this.sprites.get(random));
        }
    }

    private static final class PoplarFallingLeavesParticle extends FallingLeavesParticle {
        private PoplarFallingLeavesParticle(ClientLevel level, double x, double y, double z,
